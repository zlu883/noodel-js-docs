        ...
        noodel.nextTick(function() {
            ...
            searchButton.addEventListener("click", function(ev) {
                ...
                if (searchBar.classList.contains("hidden")) {
                    ...
                    searchButton.firstElementChild.src = "assets/x.svg";
                    searchInput.focus()
                    searchInput.select();
                }
                else {
                    ...
                    resetSearch();
                    searchButton.firstElementChild.src = "assets/search.svg";
                }
            });
